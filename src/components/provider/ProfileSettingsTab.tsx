  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-[#E8DFC9] shadow-xs">
        ...
        {isSaved && (
          <div className="flex items-center gap-1.5 text-xs font-bold text-emerald-800 bg-emerald-50 px-3 py-1.5 rounded-full border border-emerald-200 animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 sm:p-8 rounded-3xl border border-[#E8DFC9] shadow-xs space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#284435]">Company Name *</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#284435]">TALA Tourism License *</label>
            <input
              type="text"
              required
              value={talaLicense}
              onChange={(e) => setTalaLicense(e.target.value)}
              className="w-full px-3 py-2 text-xs rounded-xl border border-[#DED5C6] bg-white focus:outline-hidden font-mono"
            />
          </div>
        </div>

        <div className="space-y-1">
          <label className="text-xs font-bold text-[#284435]">Company Tagline</label>
          <input
            type="text"
            value={tagline}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#284435]">City / Region Base *</label>
            <input
              type="text"
              required
              value={location}
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#284435]">Physical Office Address</label>
            <input
              type="text"
              value={officeAddress}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#284435]">Direct Dispatch Phone *</label>
            <input
              type="text"
              required
              value={phone}
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#284435]">Official Email Address *</label>
            <input
              type="email"
              required
              value={email}
        ...
        <div className="space-y-1">
          <label className="text-xs font-bold text-[#284435]">Fleet & Safari Equipment Specs</label>
          <input
            type="text"
            value={fleetInfo}
        ...
        <div className="space-y-1">
          <label className="text-xs font-bold text-[#284435]">About Company Narrative</label>
          <textarea
            rows={4}
            value={about}
        ...
        <div className="pt-4 border-t border-[#F0EBE0] flex justify-end">
          <button
            type="submit"
            className="px-6 py-2.5 rounded-xl bg-[#284435] hover:bg-[#1E332A] text-white text-xs font-bold flex items-center gap-2 cursor-pointer shadow-xs transition-colors"
          >
