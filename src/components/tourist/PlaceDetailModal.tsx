...
export const PlaceDetailModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/75 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4 md:p-6">
      <div className="relative bg-[#FAF7F2] rounded-3xl max-w-6xl w-full h-[94vh] flex flex-col overflow-hidden shadow-2xl border border-[#E8DFC9]">
        {/* Top Control Bar with Fully Working Navigation Tabs */}
        <div className="p-3 sm:p-4 bg-white border-b border-[#E8DFC9] flex flex-wrap items-center justify-between gap-3 shrink-0 z-20">
          {/* Left: Sidebar Toggle & Destination Title */}
          <div className="flex items-center gap-2">
            <button
              onClick={() => setIsSidebarOpen(!isSidebarOpen)}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#FAF7F2] hover:bg-[#EFE7D8] text-[#284435] text-xs font-bold border border-[#E0D5C1] transition-colors cursor-pointer"
            ...
            <div className="hidden lg:flex items-center gap-1.5 text-xs text-[#6B7A72]">
              <Compass className="w-3.5 h-3.5 text-[#D97843]" />
              <span>Guide /</span>
              <strong className="text-[#284435]">{selectedDestination.name}</strong>
            </div>
          </div>

          {/* Center: The 4 Interactive Tabs (Works for ALL destinations) */}
          <div className="flex items-center gap-1 overflow-x-auto bg-[#FAF7F2] p-1 rounded-2xl border border-[#E8DFC9] text-xs max-w-full">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-bold transition-all cursor-pointer whitespace-nowrap ${
                activeSection === 'overview' 
                  ...
                  : 'text-[#52645A] hover:text-[#284435] hover:bg-[#F0EBE0]'
              }`}
            >
            ...
            >
              ...
              <span>Operators ({matchedProviders.length})</span>
            </button>
          </div>
          ...
          <button
            ...
            className="w-9 h-9 rounded-full bg-[#FAF7F2] hover:bg-[#EDE5D5] text-[#1F2A24] flex items-center justify-center transition-colors cursor-pointer shrink-0"
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {isSidebarOpen && (
            <aside className="w-72 sm:w-80 shrink-0 bg-white border-r border-[#E8DFC9] flex flex-col overflow-hidden transition-all z-10">
              <div className="p-3.5 bg-[#FAF7F2] border-b border-[#E8DFC9] flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Compass className="w-4 h-4 text-[#D97843]" />
                  <span className="font-serif font-bold text-xs text-[#284435] uppercase tracking-wider">
                    All Tanzania Destinations
                  </span>
                </div>
                <span className="text-[10px] bg-white px-2 py-0.5 rounded-md border border-[#E0D5C1] font-bold text-[#6B7A72]">
                  {destinations.length}
                </span>
              </div>
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-2.5 rounded-2xl text-left flex items-center gap-3 transition-all cursor-pointer border ${
                        isSelected 
                          ? 'bg-[#284435] text-white border-[#284435] shadow-xs' 
                          : 'bg-[#FAF7F2] hover:bg-[#EDE5D5] text-[#1F2A24] border-transparent'
                      }`}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h4 className={`font-serif font-bold text-xs truncate ${isSelected ? 'text-white' : 'text-[#284435]'}`}>
                          {dest.name}
                        </h4>
                        <p className={`text-[10px] truncate ${isSelected ? 'text-[#D3DFD7]' : 'text-[#6B7A72]'}`}>
                          {dest.region.split('(')[0]}
                        </p>
                      </div>
                    </button>
              ...
              <div className="p-3 bg-[#FAF7F2] border-t border-[#E8DFC9] text-center">
                <span className="text-[11px] text-[#6B7A72] block">
          ...
          <div className="flex-1 overflow-y-auto flex flex-col bg-[#FAF7F2]">
            ...
            {activeSection === 'overview' && (
              <div className="space-y-6 pb-12 animate-fade-in">
                ...
                <div className="px-4 sm:px-6 space-y-6">
                  ...
                  <div className="bg-white p-5 sm:p-6 rounded-2xl border border-[#E8DFC9] shadow-2xs space-y-3">
                    <div className="flex items-center gap-2">
                      <span className="w-2.5 h-2.5 rounded-full bg-[#D97843]" />
                      <h3 className="font-serif text-lg sm:text-xl font-bold text-[#284435]">About the Destination</h3>
                    </div>
                    <p className="text-xs sm:text-sm text-[#4D5E55] leading-relaxed">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-white p-5 rounded-2xl border border-[#E8DFC9] space-y-2 shadow-2xs">
                      <div className="flex items-center gap-2 text-xs font-bold text-[#284435]">
                        <div className="w-7 h-7 rounded-lg bg-[#FAF0E9] text-[#D97843] flex items-center justify-center">
                          <Calendar className="w-4 h-4" />
                        </div>
                        <span>{t('best.time', 'Best Time to Visit')}</span>
                      </div>
                      <p className="text-xs sm:text-sm text-[#4D5E55] leading-relaxed pt-1 font-medium">
                    ...
                    <div className="bg-white p-5 rounded-2xl border border-[#E8DFC9] space-y-2 shadow-2xs">
                      <div className="flex items-center gap-2 text-xs font-bold text-[#284435]">
                        <div className="w-7 h-7 rounded-lg bg-[#FAF7E8] text-[#E8B94A] flex items-center justify-center">
                          <Coins className="w-4 h-4 text-[#C4942B]" />
                        </div>
                        <span>{t('typical.cost', 'Typical Daily Cost')}</span>
                      </div>
                      <p className="text-xs sm:text-sm text-[#284435] font-bold pt-1">
                  ...
                  <div className="bg-white p-5 sm:p-6 rounded-2xl border border-[#E8DFC9] space-y-3 shadow-2xs">
                    <h4 className="font-serif font-bold text-sm sm:text-base text-[#284435] flex items-center gap-2">
                      <Sparkles className="w-4 h-4 text-[#E8B94A]" />
                      <span>Key Highlights & Signature Experiences</span>
                    </h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                      {selectedDestination.highlights.map((highlight, index) => (
                        <div key={index} className="flex items-start gap-2.5 p-3 rounded-xl bg-[#FAF7F2] border border-[#E8DFC9]/60">
                          <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                          <span className="text-xs text-[#384840] font-medium leading-relaxed">{highlight}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                    <button
                      type="button"
                      onClick={() => setActiveSection('photos')}
                      className="p-4 rounded-2xl bg-white hover:bg-[#FAF7F2] border border-[#E8DFC9] hover:border-[#284435] transition-all text-left group cursor-pointer shadow-2xs"
                    >
                      <div className="flex items-center justify-between mb-2">
                        <Camera className="w-5 h-5 text-[#D97843]" />
                        <ArrowRight className="w-4 h-4 text-[#6B7A72] group-hover:translate-x-1 transition-transform" />
                      </div>
                      <h4 className="font-serif font-bold text-xs sm:text-sm text-[#284435] mb-1">
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <ShieldCheck className="w-5 h-5 text-[#284435]" />
                        <ArrowRight className="w-4 h-4 text-[#6B7A72] group-hover:translate-x-1 transition-transform" />
                      </div>
                      <h4 className="font-serif font-bold text-xs sm:text-sm text-[#284435] mb-1">
                        Logistics & Park Fees
                    ...
                    >
                      ...
                      <h4 className="font-serif font-bold text-xs sm:text-sm text-[#284435] mb-1">
                        Verified Operators ({matchedProviders.length})
                      </h4>
                      <p className="text-[11px] text-[#6B7A72]">
            ...
            {activeSection === 'photos' && (
              <div className="p-4 sm:p-6 space-y-6 flex-1 flex flex-col animate-fade-in">
                ...
                {currentImages.length > 1 && (
                  <div className="bg-white p-3 rounded-2xl border border-[#E8DFC9] flex items-center gap-2.5 overflow-x-auto shadow-2xs">
                    <span className="text-xs font-bold text-[#284435] pl-2 shrink-0 flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className={`relative w-20 h-14 rounded-xl overflow-hidden shrink-0 border-2 transition-all cursor-pointer ${
                          activePhotoIndex === idx 
                            ? 'border-[#284435] ring-2 ring-[#284435]/30 scale-105 shadow-xs' 
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {currentImages.map((img, idx) => (
                      <button
                        ...
                        className={`p-2.5 rounded-2xl bg-white border text-left transition-all cursor-pointer group shadow-2xs ${
                          activePhotoIndex === idx 
                            ? 'border-[#284435] ring-2 ring-[#284435]/20' 
                            : 'border-[#E8DFC9] hover:border-[#D97843]'
                        }`}
                      >
                        ...
                        <p className="text-xs font-semibold text-[#284435] line-clamp-2 leading-relaxed">
                          {img.caption}
                        </p>
                      </button>
                    ))}
            ...
            {/* ============================================================ */}
            {activeSection === 'logistics' && (
              <div className="p-4 sm:p-6 space-y-6 flex-1 text-[#1F2A24] animate-fade-in">
                {/* Official Park Tariffs & Fee Structure */}
                <div className="bg-white p-5 sm:p-6 rounded-2xl border border-[#E8DFC9] shadow-2xs space-y-4">
                  <div className="flex items-start justify-between gap-2 border-b border-[#E8DFC9] pb-3">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="w-2.5 h-2.5 rounded-full bg-emerald-600" />
                        <h3 className="font-serif text-base sm:text-lg font-bold text-[#284435]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                    <div className="p-3.5 rounded-xl bg-[#FAF7F2] border border-[#E8DFC9]/70 space-y-1">
                      <span className="text-[11px] font-bold text-[#52645A] uppercase tracking-wider block">
                        Conservation Fee (Per Person / 24 Hours)
                      </span>
                      <p className="font-bold text-sm text-[#284435]">
                  ...
                  {selectedDestination.parkFees?.concessionOrCampFee && (
                    <div className="p-3 rounded-xl bg-[#FAF7E8] border border-[#E8B94A]/40 text-xs text-[#384840]">
                      <strong>Concession & Campsite Fee: </strong>
                      <span>{selectedDestination.parkFees.concessionOrCampFee}</span>
                    </div>
                  )}

                  <div className="p-3 rounded-xl bg-[#EAF3EC] border border-[#CDE3D4] flex items-center gap-2 text-xs text-[#284435]">
                ...
                <div className="bg-white p-5 sm:p-6 rounded-2xl border border-[#E8DFC9] shadow-2xs space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                    <div className="p-3 rounded-xl bg-[#FAF7F2] border border-[#E8DFC9]/70">
                      <span className="text-[10px] font-bold text-[#6B7A72] uppercase block mb-1">
                        Nearest Airport / Airstrip
                      </span>
                      <span className="font-bold text-[#284435]">
                  ...
                  {selectedDestination.logisticsInfo?.accessRoute && (
                    <p className="text-xs text-[#4D5E55] leading-relaxed pt-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Regulations */}
                  <div className="bg-white p-5 rounded-2xl border border-[#E8DFC9] shadow-2xs space-y-3">
                    <h4 className="font-serif font-bold text-sm text-[#284435] flex items-center gap-2">
                      <AlertCircle className="w-4 h-4 text-[#D97843]" />
                      <span>Mandatory Park Regulations</span>
                    </h4>
                    <ul className="space-y-2 text-xs text-[#4D5E55]">
            ...
            {activeSection === 'operators' && (
              <div className="p-4 sm:p-6 space-y-6 flex-1 text-[#1F2A24] animate-fade-in">
                {/* Header Information */}
                <div className="flex flex-wrap items-baseline justify-between gap-2 border-b border-[#E8DFC9] pb-3">
                  <div>
                    <h3 className="font-serif text-lg sm:text-xl font-bold text-[#284435]">
                  ...
                  <span className="text-xs font-bold text-[#284435] bg-white px-3 py-1.5 rounded-xl border border-[#E8DFC9] shadow-2xs">
                    {matchedProviders.length} Verified Specialist{matchedProviders.length !== 1 ? 's' : ''}
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  {matchedProviders.map((prov) => {
                    ...
                    return (
                      <div
                        key={prov.id}
                        className="bg-white p-5 rounded-3xl border border-[#E8DFC9] hover:border-[#284435] transition-all shadow-2xs space-y-4"
                      >
                        {/* Operator Info Row */}
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <h4 className="font-serif font-bold text-base sm:text-lg text-[#284435]">
                                {prov.name}
                              </h4>
                              <div className="flex items-center gap-1 text-xs text-amber-700 font-semibold bg-amber-50 px-2 py-0.5 rounded-md border border-amber-200">
                                <Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
                                <span>{prov.rating.toFixed(1)}</span>
                                <span className="text-[#6B7A72]">({prov.reviewsCount})</span>
                              </div>
                            </div>
                            ...
                            <p className="text-xs text-[#4D5E55] line-clamp-2 max-w-2xl">
                              {prov.about}
                            </p>
                          </div>
                          ...
                          <div className="sm:text-right shrink-0">
                            ...
                            <span className="text-sm font-bold text-[#284435] block">
                        ...
                        <div className="flex flex-wrap items-center gap-2 pt-1 border-t border-[#F0EBE0]">
                          <span className="text-[10px] font-semibold text-emerald-800 bg-emerald-50 px-2.5 py-1 rounded-md border border-emerald-200">
                            <ShieldCheck className="w-3 h-3 inline mr-1 text-emerald-600" />
                            {prov.talaLicense}
                          </span>
                          <span className="text-[10px] text-[#52645A] bg-[#FAF7F2] px-2 py-1 rounded-md border border-[#E8DFC9]">
                            📍 {prov.location}
                          </span>
                          {prov.fleetInfo && (
                            <span className="text-[10px] text-[#52645A] bg-[#FAF7F2] px-2 py-1 rounded-md border border-[#E8DFC9]">
                          ...
                          <div className="space-y-2 pt-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              {provPackages.map((pkg) => (
                                <div
                                  key={pkg.id}
                                  className="p-3.5 rounded-2xl bg-[#FAF7F2] border border-[#E8DFC9]/80 flex flex-col justify-between hover:border-[#284435] transition-all"
                                >
                                  <div>
                                    <div className="flex items-start justify-between gap-2 mb-1">
                                      <h5 className="font-serif font-bold text-xs text-[#284435]">
                                        {pkg.title}
                                      </h5>
                                      <span className="text-[10px] font-bold bg-white px-2 py-0.5 rounded-md border border-[#E8DFC9] text-[#6B7A72] shrink-0">
                                        {pkg.duration}
                                      </span>
                                    </div>
                                    <p className="text-[11px] text-[#6B7A72] line-clamp-2 mb-2">
                                      {pkg.description}
                                    </p>
                                  </div>

                                  <div className="flex items-center justify-between pt-2 border-t border-[#E8DFC9]/60">
                                    <span className="text-xs font-bold text-[#284435]">
